...
<div className="mb-10 text-center py-8 border-y border-slate-200 my-8">
    ...
    <div className="mt-8 flex flex-col items-center justify-center">
        <Button href="https://www.eventbrite.com/e/empowering-communities-a-cancer-awareness-and-education-event-tickets-1977326317243?aff=oddtdtcreator&keep_tld=1" variant="solid" color="blue">
            Register Here
        </Button>
    </div>
</div>
