          ...
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <dl className="mt-10 space-y-4 text-base/7 text-slate-600">
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="tel:+1-226-698-2573" className="hover:text-slate-900">
                    +1-226-698-2573
                  </a>
                </dd>
              </div>
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="mailto:support@allianceforcancercareequity.ca" className="hover:text-slate-900">
               ...
               <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="mailto:volunteer@allianceforcancercareequity.ca" className="hover:text-slate-900">
               ...
               <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="mailto:info@allianceforcancercareequity.ca" className="hover:text-slate-900">
        ...
        <form action="#" method="POST" className="px-6 pt-20 pb-24 sm:pb-32 lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                <label htmlFor="phone-number" className="block text-sm/6 font-semibold text-slate-900">
                  Phone number
                </label>
                <div className="mt-2.5">
                  <input
