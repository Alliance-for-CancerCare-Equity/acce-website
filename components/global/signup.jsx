                        ...
                        <div className="sing-up-body">
                            ...
                            <form className="sing-up-items row gy-4 gx-3">
                                <div className="col-md-12">
                                    <label htmlFor="fullName" className="form-label">{block.form.fullname.heading}</label>
                                    <input
                                        type="text"
                                ...
                                <div className="col-md-12">
                                    <label htmlFor="pEmailId" className="form-label">{block.form.email.heading}</label>
                                    <input
                                        type="email"
                                        className="form-control"
                                        id="pEmailId"
                                ...
                                <div className="col-md-12">
                                    <label htmlFor="setpassword" className="form-label">{block.form.password.heading}</label>
