                                ...
                                <>
                                    <form method="post">
                                        ...
                                        { block.form.fullname && 
                                            <>
                                                <div className="col-md-12">
                                                    <label htmlFor="Name" className="label">{block.form.fullname.heading}</label>
                                                    <input
                                                        type="text"
                                        ...
                                        { block.form.phone_number && 
                                            <>
                                                <div className="col-md-12">
                                                    <label htmlFor="phone-number" className="label">{block.form.phone_number.heading}</label>
                                                    <input
                                                        type="tel"
                                                        className="form-control"
                                                        id="phone-number"
                                        ...
                                        { block.form.email && 
                                            <>
                                                <div className="col-md-12">
                                                    <label htmlFor="email" className="label">{block.form.email.heading}</label>
                                                    <input
                                                        type="email"
                                        ...
                                        { block.form.message && 
                                            <>
                                                <div className="col-md-12">
                                                    <label htmlFor="message" className="label">{block.form.message.heading}</label>
                                                    <textarea
